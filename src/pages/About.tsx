...
const breedStandard = {
  general:
    "Malý, o něco delší než čtvercový rámec, harmonicky stavěný pes. Působí atraktivně díky efektně zbarvené bohaté srsti. Výraz milého a příjemného společníka. Barevná bolonka se nesmí typem přibližovat pudlovi anebo Shih-Tzu.",
  characteristics: [
    {
      icon: Ruler,
      label: "Výška",
  ...
  sections: [
    {
      title: "Hlava",
      content:
        "Proporcionální k celkové stavbě těla. Lebka okrouhlá, lehce vypouklá, týlní hrbol málo výrazný. Stop krátký, dobře znatelný. Čenich není dlouhý, suchý, lehce se zužující k nosu. Nosní hřbet je rovný, mezi očima široký.",
    },
    {
      title: "Oči a uši",
      content:
        "Oči střední velikosti, tmavé, okrouhlé, přímo hledící. Výraz lehce hravý a laskavý. Uši střední velikosti, trojúhelníkového tvaru s lehce okrouhlou špičkou, povislé, úměrně vysoce posazené, s bohatou srstí.",
    },
    {
      title: "Trup",
      content:
        "Kompaktní, středně široký. Hřbet rovný, silný, široký, osvalený. Bedra krátká, mírně klenutá. Záď zaoblená, přiměřené délky, dost široká, lehce spáditá. Hrudní koš středně široký, oválný, dlouhý, hluboký v loktech.",
    },
    {
      title: "Srst",
      content:
        "Dlouhá, sametová, lesklá, hustá s dobře vyvinutou podsadou, rovnoměrně pokrývá celého psa. Vlas je silný a 'těžký'. Preferována je kadeřavá srst, povolená vlnitá.",
    },
    {
      title: "Končetiny",
      content:
        "Při pohledu zepředu jsou rovné a v postoji paralelní, poměrně široce postavené. Lopatky šikmo umístěné, dobře osvalené. Tlapky nevelké, okrouhlé formy, prsty jsou klenuté a pevně semknuté.",
    },
    {
      title: "Ocas",
      content:
        "Střední délky, vysoce nasazený, zatočený srpovitě na zádech anebo leží na zádi. Konec ocasu se dotýká těla. Ocas je plně osrstěný.",
    },
  ],
  proportions: [
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <div className="card-warm">
                <h2 className="font-display text-2xl font-semibold text-foreground mb-4">Celkový vzhled</h2>
                <p className="text-muted-foreground leading-relaxed mb-6">{breedStandard.general}</p>
                <h3 className="font-display text-lg font-semibold text-foreground mb-3">Důležité proporce</h3>
            ...
            >
              {breedStandard.characteristics.map((char, index) => (
                ...
                >
                  ...
                  <p className="font-display text-2xl font-bold text-foreground mb-1">{char.value}</p>
        ...
        <section className="py-16 bg-background overflow-hidden">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-muted-foreground">Detailní popis jednotlivých částí těla dle standardu FCI</p>
            </motion.div>
            ...
            >
              {breedStandard.sections.map((section, index) => (
                <motion.div
                  ...
                  whileHover={prefersReducedMotion ? {} : { y: -5, transition: { duration: 0.2 } }}
                >
                  <h3 className="font-display text-xl font-semibold text-foreground mb-3">{section.title}</h3>
        ...
        <section className="py-16 gradient-warm overflow-hidden">
          <div className="container mx-auto px-6">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="font-display text-3xl md:text-4xl font-semibold text-foreground mb-4">Vady</h2>
              <p className="text-muted-foreground">Jakákoliv odchylka od standardu je považována za vadu</p>
            </motion.div>
            ...
            >
              {/* Minor Faults */}
              <motion.div className="card-warm" variants={scaleIn} transition={{ duration: 0.5 }}>
              ...
              {/* Serious Faults */}
              <motion.div className="card-warm" variants={scaleIn} transition={{ duration: 0.5, delay: 0.1 }}>
                <h3 className="font-display text-lg font-semibold text-foreground mb-4 flex items-center gap-2">
              ...
              <motion.div className="card-warm" variants={scaleIn} transition={{ duration: 0.5, delay: 0.2 }}>
                <h3 className="font-display text-lg font-semibold text-foreground mb-4 flex items-center gap-2">
